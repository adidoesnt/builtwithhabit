	...
	>
		...
		{#if hasToken}
			<form
				...
				action="/training/reset-password"
				method="POST"
			...
			>
				...
				<div
					class="flex flex-col-reverse gap-4 pt-2 md:flex-row md:items-center md:justify-between"
				>
					<div class="flex flex-col gap-2">
		...
		{:else}
			<div class="text-center">
				<h1 class="text-2xl font-semibold">Invalid Reset Link</h1>
				<p class="text-light-brown text-sm">This password reset link is invalid or has expired.</p>
				<a
					href="/training/forgot-password"
					class="text-dark-brown mt-4 inline-block text-sm transition-all duration-300 hover:underline"
